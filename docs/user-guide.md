...
17. [Docker Compose (Single File)](#docker-compose-single-file)
...
For production RuvSense Edge deployments and local Docker Desktop checks, use the single compose file:
